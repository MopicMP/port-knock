...
> Simple port knocking implementation

[![PyPI version](https://badge.fury.io/py/port-knock.svg)](https://pypi.org/project/port-knock/)
...
result = knock("Hello World")

# Example 2: Batch processing
from port_knock import batch
